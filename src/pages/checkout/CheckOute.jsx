      ...
      <div className="container">
        ...
        <div className={styles.returningCustomer}>
          ...
          <form className="row g-4">
            ...
            <div
              className={`col-md-12 form-group d-flex flex-wrap ${styles.flexWrap}`}
            >
              <a href="/login" className={`btn ${styles.btn}`}>
                Log in
              </a>
              <div className={`${styles.checkoutCap} ml-5`}>
                <input type="checkbox" id="keep-log" />
